...
Route::get('/prestamos', [PrestamoMaterialController::class, 'index']);
Route::post('/prestamos', [PrestamoMaterialController::class, 'store']);
Route::get('/prestamos/{id}', [PrestamoMaterialController::class, 'show']);
Route::put('/prestamos/{id}', [PrestamoMaterialController::class, 'update']);
Route::delete('/prestamos/{id}', [PrestamoMaterialController::class, 'destroy']);
